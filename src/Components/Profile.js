...
function Profile() {
  ...
  return (
   ...
   <Grid container spacing={1}>
    ...
    <Typography paragraph={true} sx={{fontFamily:"Poppins", fontSize:{xs:"15px", md:"17px"}, mt:"12px", color:'#7844e9'}}> React Developer </Typography>
    </Grid>
    ...
    <Typography variant="h5" className='myDesignation' sx={{ fontSize:'28px' ,color:"#7844e9" ,  fontWeight:'bold',  textShadow:'0 0 10px #7844e9' }}>React Developer </Typography>
