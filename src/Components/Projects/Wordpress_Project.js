  ...
  return (
    <>
        ...
        <a href=" http://tngwebsolutions.ca/  "  target='_blank'>
          <img src="Websites_screenshots/tngwebsolutions.jpg" alt="tngwebsolutions" width="98%"/>
          </a>
        </Grid>
        <Grid item xs={6}>
        <a href="https://rdhaliwalinsurance.ca/"  target='_blank'>
          <img src="Websites_screenshots/rdhaliwal.jpg" alt="rdhaliwal" width="98%" />
          </a>
        </Grid>
        <Grid item xs={6}>
        ...
        <a href="https://calgaryinsurancequotes.com/"  target='_blank'>
          <img src="Websites_screenshots/calgary_insurance.jpg" alt="calgary_insurance" width="98%" />
          </a>
        </Grid>
        <Grid item xs={6}>
        ...
        <a href="  https://bombaybakery.ca/"  target='_blank'>
          <img src="Websites_screenshots/Bombaybakery.jpg" alt="Bombaybakery" width="98%" />
          </a>
        </Grid>
        <Grid item xs={6}>
        <a href=" https://bombaydosacafe.ca/"  target='_blank'>
          <img src="Websites_screenshots/Bombaydosacafe.jpg" alt="Bombaydosacafe" width="98%" />
          </a>
        </Grid>
        <Grid item xs={6}>
        <a href="https://bombaychowpatty.ca/"  target='_blank'>
          <img src="Websites_screenshots/chowpatty.jpg" alt="bombaychowpatty" width="98%" />
          </a>
        </Grid>
